...
module.exports = {
	...
	onStart: async function ({ message }) {
		const authorName = " WAHID ッ ";
		const ownAge = "『 21 』";
		const messenger = "https://www.facebook.com/profile.php?id=100087853252386";
		const authorFB = "https://www.facebook.com/profile.php?id=100087853252386";
		const authorNumber = "এইটা পার্সোনাল";
		const Status = "complicated";
		const urls = [
"https://i.imgur.com/MBTZpxj.jpeg",
"https://i.imgur.com/VDOiifK.jpeg",
"https://i.imgur.com/4SEIjFA.jpeg",
"https://i.imgur.com/kwXDHza.jpeg"
];
...
\🤖彡𝐵𝑜𝑡 𝑁𝑎𝑚𝑒 : ⩸_WAHID BOT_${global.GoatBot.config.nickNameBot}__⩸
